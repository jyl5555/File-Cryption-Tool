...
name = Label(root,text='加密或解密的文件(可拖入):').grid(row=0,column=0)
name_2 = Entry(root,font=font)
name_2.grid(row=0,column=1)

password_1 = Label(root,text='加密或解密的密码:').grid(row=1,column=0)
password_2 = Entry(root,font=font,show="*")
password_2.grid(row=1,column=1)
data_1 = Label(root,text='保存路径(可不填):').grid(row=2,column=0)
...
name_3 = Button(root,text='浏览...',command=openfile,bootstyle=(INFO,OUTLINE)).grid(row=0,column=2)
data_3 = Button(root,text='浏览...',command=savefile,bootstyle=(INFO,OUTLINE)).grid(row=2,column=2)
password_3 = Button(root,text='生成密钥',command=keys,bootstyle=(INFO,OUTLINE)).grid(row=1,column=2)
button = Button(root,text='加密或解密',command=main,bootstyle=(INFO,OUTLINE)).grid(row=3,column=1)
